...
const NavBar = () => {
  ...
  return (
    <View className={Toggle ? "navbar_container show-nav" :
        "navbar_container"}>
            ...
            <Flex className='selections-container'>
                ...
                <Flex className='bullets-container'>
                    <View className='nav-container'>
                        <a href="/Versus" style={{ textDecoration: 'none', color: 'inherit' }}>
            ...
            <Flex className="toggle-arrow-container">
                <View className='arrow-icon'>
                    ...
                    left="21.88%"
                    right="21.88%"
                    style={{ cursor: 'pointer', transform: Toggle ? 'rotate(0deg)' : 'rotate(180deg)' }}
            ...
            <Flex className='user-container'>
                ...
                <Text className='username'>
                    {ismyUserNull() ? (<p>Username</p>) : myUser.username}
