...
const NavBar = () => {
  ...
  return (
    <View className={Toggle ? "navbar_container show-nav" : "navbar_container"}>
      ...
      <Flex className="selections-container">
        ...
        <Flex className="bullets-container">
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Text className="nav-text">Leaderboard</Text>
          </a>
        </Flex>
        ...
        <Flex className="bullets-container">
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Text className="nav-text">Battle</Text>
          </a>
        </Flex>
        ...
        <Flex className="bullets-container">
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Text className="nav-text">Battleboard</Text>
          </a>
        </Flex>
        ...
        <Flex className="bullets-container">
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Text className="nav-text">Upload</Text>
          </a>
        </Flex>
        ...
        <Flex className="bullets-container">
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Text className="nav-text">Activity</Text>
          </a>
        </Flex>
        ...
        <Flex className="bullets-container">
          ...
          <a
            ...
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Text className="nav-text">Friends</Text>
          </a>
        </Flex>
      </Flex>
