  ...
  return (
    <View className='navbar_container'>
        <Text className='logo-text'>
            <span class="blue-text">drip</span>
            <span>drop.</span>
        </Text>
