...
export default function LeaderUser({ user }) {
  ...
  return (
    <div
      style={{
        maxWidth: "350px", // Increased maximum width
        margin: "0 auto",
...
const styles = {
    container: {
      maxWidth: "100%", // Set maximum width to 100% to ensure it fits the screen
      maxHeight: "100%",
      overflow: "auto", // Add horizontal scrollbar if content overflows
      display: "flex",
    ...
    profile: {
      textAlign: "center",
      maxWidth: "95%", // Adjust maximum width of the profile section
      margin: "0 auto", // Center the profile section horizontally
    },
    heading: {
      fontSize: "20px",
      fontWeight: "bold",
