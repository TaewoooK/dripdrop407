    ...
    <Flex direction="row" justifyContent="center" gap="0.5rem">
      ...
      <View className="big-post-containerv2">
        ...
        {/* <View className="thumb-container1v2">
          ...
          <View className="thumb-container2v2">
            <Icon
              width="33.52px"
              height="30.94px"
              viewBox={{
      ...
      {showComment && (
        ...
        >
          <motion.Text
            initial={{ x: "100vw" }}
            animate={{ x: 0 }}
            className="header-textv2"
          >
            Comments
          </motion.Text>
          <Flex className="text-field-containerv2">
            <TextField
              width="253px"
              height="unset"
