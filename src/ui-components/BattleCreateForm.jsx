...
export default function BattleCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPlayer1Status(initialValues.Player1Status);
    setPlayer2Status(initialValues.Player2Status);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBattle.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BattleCreateForm")}
      {...rest}
    >
      <TextField
        label="Player1"
